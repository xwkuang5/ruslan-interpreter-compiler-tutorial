...
import { INTEGER_CONST, REAL_CONST, PLUS, MINUS, MULT, DIV, LEFTPR, RIGHTPR, Token, DOT, BEGIN, END, SEMICOLON, ID, ASSIGN, EOF, PROGRAM, VAR, COMMA, COLON, FLOAT_DIV, INTEGER_DIV } from "./token";
import { AST, BinOp, UnaryOp, Num, Compound, Var, Assign, NoOp, Block, VarDeclaration, Type, Program } from "./ast";
...
export class Parser {
    ...
    private declarations(): Array<VarDeclaration> {
        // declarations : VAR (variable_declaration SEMI)+
        //              | empty

        let declarationsList: Array<VarDeclaration> = [];
